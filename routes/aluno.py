...
from models.modelos import Turma, Conversation, Tutor, Aluno, TutorEmbed
...
async def create_aluno_for_turma(turma_id: str, aluno: Aluno):
    ...
    aluno.tutor_id = turma.tutor.id  # Agora usando o id do TutorEmbed
    aluno.turma_id = ObjectId(turma_id)
    turma.aluno.append(aluno)
